module Spider
  module Feeds
    class Messagekast < Spider::Feeds::Base
      class << self
        def urls
          ['http://adkast.messagekast.com/adkast/feed/cityspade.com/?id=lgpfcqrf',
           'http://adkast.messagekast.com/adkast/feed/cityspade.com/?id=qmnkacgp']
        end
        def read_obj url
